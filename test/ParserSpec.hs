...
testParseSubExp =
  "parseSubExp" ~:
  [ "( SELECT B )" ~: Right (Just $ A.COLUMNS Nothing [A.COLUMN "B" Nothing]) ~=?
    BP.parseOnly (P.parseSubExp P.parseColumnsExp) "( SELECT B )"
  , "( SELECT B ) something else" ~: Right (Just $ A.COLUMNS Nothing [A.COLUMN "B" Nothing]) ~=?
  ...
  , "( SELECT B )" ~: Right (A.COLUMNS Nothing [A.COLUMN "B" Nothing]) ~=?
    BP.parseOnly (P.parseSubExp' P.parseColumnsExp) "( SELECT B )"
  , "( SELECT B ) something else" ~: Right (A.COLUMNS Nothing [A.COLUMN "B" Nothing]) ~=?
    BP.parseOnly (P.parseSubExp' P.parseColumnsExp) "( SELECT B ) something else"
